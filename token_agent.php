...
<div onclick="location.href='token_agent'" class="active" ><i class="fa-solid fa-seedling"></i> Token Agents</div>
...
<div class="prompt">> TOKEN AGENT INTELLIGENCE</div>
</div>
...
type="text" 
id="searchAgent" 
placeholder="Search by username or token address..." 
...
<div id="tokenAgents" class="terminal-body">
<p>SCANNING TOKEN AGENTS...</p>
</div>
...
<script src="vendors/agent_token.js"></script>
